...
def parse_args():
    ...
    parser.add_argument('--network', type=str, default='resnet18', help='base network')
    #parser.add_argument('--pretrained', type=str, default='model/resnet-50init.params', help='path to pretrained model')
    parser.add_argument('--pretrained', type=str, default='model/resnet-18-0000.params', help='path to pretrained model')
    parser.add_argument('--dataset', type=str, default='voc', help='training dataset')
    parser.add_argument('--imageset', type=str, default='train', help='imageset splits')
    parser.add_argument('--gpus', type=str, default='0,1', help='gpu devices eg. 0,1')
    ...
    parser.add_argument('--log-interval', type=int, default=10, help='logging mini batch interval')
    parser.add_argument('--save-prefix', type=str, default='mode/test_l_res18', help='saving params prefix')
    # faster rcnn params
    parser.add_argument('--img-short-side', type=int, default=900)
    ...
    parser.add_argument('--rpn-anchor-scales', type=str, default='(6, 12, 18, 32)')
    ...
    parser.add_argument('--rcnn-num-classes', type=int, default=2)
...
def get_voc(args):
    ...
    roidb = []
    for iset in isets:
        imdb = PascalVOC(iset, '/home/public/test_net_data/lsil_out', '/home/public/test_net_data/lsil_out')
...
def get_resnet18_train(args):
    from symnet.symbol_resnet import get_resnet_train
    if not args.pretrained:
        args.pretrained = 'model/resnet-18-0000.params'
    if not args.save_prefix:
        args.save_prefix = 'model/resnet18'
