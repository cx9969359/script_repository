...
class CustomVOC(IMDB):
    def __init__(self, image_set, root_path, data_path):
        ...
        super(CustomVOC, self).__init__('custom_voc', image_set, root_path, data_path)  # set self.name
    ...
    def load_image_set_index(self):
        ...
        #image_set_index_file = os.path.join(self.data_path, 'ImageSets', 'Main', 'train.txt')
    ...
    def evaluate_detections(self, detections):
        ...
        result_dir = os.path.join(self.eval_path, 'results')
        if not os.path.exists(result_dir):
            os.mkdir(result_dir)
        year_folder = os.path.join(self.eval_path, 'results', 'CustomVOC')
        if not os.path.exists(year_folder):
            os.mkdir(year_folder)
        res_file_folder = os.path.join(self.eval_path, 'results', 'CustomVOC', 'Main')
